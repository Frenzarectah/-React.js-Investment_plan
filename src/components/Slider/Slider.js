...
const Slider = () =>{
    const [valuerMin, setValuerMin] = useState(1);
    ...
    return(
        <div className="mt-[20px] w-full">
              ...
              <input id="slider1" type="range" min="0" max="5" step="1" className="w-full slider" onChange={(e)=>setValuerMax(interval[e.target.value])}/>
